...
inline  double *dvector(int nl, int nh)
	{
			double *v;
...
inline  void free_dvector(double *v,int nl,int nh)
	{
...
inline  void free_ivector(int *v, int nl, int nh)
...
//
inline void free_matrix( double **m, int nrl, int ncl )
	{
...
inline void free_imatrix( int **m, int nrl, int ncl )
{
