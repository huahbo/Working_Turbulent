 ...
 *  Last Modified: Time-stamp: <2014-08-20 12:56:08 mike_georgiou>
 *
 *
                              ...
                              double* explicit_term)
{
  ...
  //Convection Term
  double  convection_term= Convection_Term2ND(velocity_z,
                                              flux_x, flux_y,flux_z,
                                              dx, dy, dz,
                                              i, j, k);

  double viscous_term=  Viscous_Term2ND(velocity_z,
                                        eddy_viscosity,
                                        explicit_term,
                                        Reynolds,
                                        dx, dy, dz,
  ...
  //Viscous Term XX
  residual_z[k][j][i] = -convection_term + viscous_term + source;
