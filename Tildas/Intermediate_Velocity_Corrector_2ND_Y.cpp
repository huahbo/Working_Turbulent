 ...
 *  Last Modified: Time-stamp: <2014-09-04 17:48:30 mike_georgiou>
 *
 *
...
void Intermediate_Velocity_Corrector_2ND_Y(double***velocity_y_tilda,
                                           double*** residual_y,
        ...
        if (j==0)
          {
            ...
            rhs[j+1] =
              dt/rho_new[k][j][i]
              *(rho[k][j][i]*velocity_y_old[k][j][i]/dt
